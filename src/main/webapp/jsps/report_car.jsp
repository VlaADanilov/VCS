...
<body>
    <div id = "wrapper">
        <div id = "header" align="center">
            <img class="myImage" src="icons/back.jpg" onclick="location.href='${pageContext.servletContext.contextPath}/back_dispetcher?whereBack=${param.whereBack}&from=toInfo&number=${param.auto_id}'">
